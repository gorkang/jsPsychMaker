...
data_type = {
    'Image': {'page1': {text: instructions_p1("Image")},
              ...
              'page2': {text: "<H2>Instrucciones (2/3)</H2>Usando la prevalencia, sensibilidad y especificidad es posible calcular:<BR><BR>" + 
                              ...
                              // Images
                              '<img class="image_zoom" src="media/images/Bayesian22/instructions1.png" style="max-width: 40%; max-height: 40%;"> <img class="image_zoom" src="media/images/Bayesian22/instructions2.png" style="max-width: 40%; max-height: 40%;">' +
                              "<BR><BR>"
                              },
