...
questions.push( check_fullscreen('DEBRIEF40') );
DEBRIEF40 = [];    //temporal timeline

var instruction_screen_experiment = {
    type: 'instructions',
    pages: ['<p><left>' +
    '<p><left><b><big>Última tarea</big></b><br />'+'Por favor, contesta a las siguientes dos preguntas sobre el estudio' +'</p>'],
    data: {trialid: 'Instructions_01', procedure: 'DEBRIEF40'},
...
var question00 = {
  ...
  data: {trialid: 'DEBRIEF40_01', procedure: 'DEBRIEF40'}
}; 
  
DEBRIEF40.push(question00);
...
var question01 = {
  ...
  data: {trialid: 'DEBRIEF40_02', procedure: 'DEBRIEF40'}
};
DEBRIEF40.push(question01);
...
var question02 = {
  ...
  data: {trialid: 'DEBRIEF40_03', procedure: 'DEBRIEF40'}
};
DEBRIEF40.push(question02);

DEBRIEF40.unshift(instruction_screen_experiment);
DEBRIEF40.push.apply(questions, DEBRIEF40)


call_function("DEBRIEF40");
