...
questions.push( check_fullscreen('DEBRIEF22') );
DEBRIEF22 = [];    //temporal timeline

var instruction_screen_experiment = {
    type: 'instructions',
    pages: ['<p><left>' +
    '<p><left><b><big>Última tarea</big></b><br />'+'Por favor, contesta a las siguientes dos preguntas sobre el estudio' +'</p>'],
    data: {trialid: 'Instructions_01', procedure: 'DEBRIEF22'},
...
var question00 = {
 type: 'survey-multi-select',
  ...
  data: {trialid: 'DEBRIEF22_01', procedure: 'DEBRIEF22'}
  }; 
  
DEBRIEF22.push(question00);
...
var question01 = {
  ...
  data: {trialid: 'DEBRIEF22_02', procedure: 'DEBRIEF22'}
};
DEBRIEF22.push(question01);
...
var question02 = {
  ...
  data: {trialid: 'DEBRIEF22_03', procedure: 'DEBRIEF22'}
};
DEBRIEF22.push(question02);

DEBRIEF22.unshift(instruction_screen_experiment);
DEBRIEF22.push.apply(questions, DEBRIEF22)


call_function("DEBRIEF22");
