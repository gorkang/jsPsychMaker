...
var instruction_screen_experiment = {
    ...
    message: [`Contesta a las siguientes 5 preguntas de manera honesta. <BR><BR>Recuerda que tus datos son confidenciales.<BR><BR>`],
    button_label: 'Iniciar el formulario en pantalla completa',
    data: {trialid: 'Instructions', procedure: 'FORM'},
...
var question01 = {
  type: 'survey-text',
  questions: [{prompt: '<div class="justified">Indica tu edad</div>', type: 'number', range: [1, 110], required: true, error_text: 'Tiene que ser un número entre 1 y 110'}],
  data: {trialid: 'FORM_01', procedure: 'FORM'}
};
FORM.push(question01);
...
var question02 = {
  ...
  data: {trialid: 'FORM_02', procedure: 'FORM'}
};
FORM.push(question02);
...
var question03 = {
  ...
  data: {trialid: 'FORM_03', procedure: 'FORM'}
};
FORM.push(question03);
...
var question04 = {
  ...
  data: {trialid: 'FORM_04', procedure: 'FORM'}
};
FORM.push(question04);
...
var question05 = {
  ...
  data: {trialid: 'FORM_05', procedure: 'FORM'}
};
FORM.push(question05);
...
var question06 = {
  ...
  data: {trialid: 'FORM_06', procedure: 'FORM'}
};
FORM.push(question06);

FORM.unshift(instruction_screen_experiment);
FORM.push.apply(questions, FORM)
...
var instruction_screen_experiment = {
    type: 'instructions',
    pages: ['<p><left><b><big>¡Gracias!</big></b><br />'+
    'Gracias por tu tiempo. Si eres seleccionada para el estudio contactaremos contigo al email que nos has indicado.' +'</p>'],
...
questions.push({
    ...
    func: function(){
      if (online) {
        var data = jsPsych.data.get().filter({procedure: 'FORM'}).csv();
      } else {
        var data = jsPsych.data.get().filter({procedure: 'FORM'}).json();
      }
      saveData(data, online, 'FORM');
    },
    procedure: 'FORM'
});
