...
var question01 = {
  type: 'survey-text',
  questions: [{prompt: '<div class="justified">Indique su nombre completo</div>', type: 'text', range: [10, 200], required: true}],
...
var question02 = {
  type: 'survey-text',
  questions: [{prompt: '<div class="justified">Indique su rut , sin puntos ni guión y con dígito verificador</div>', type: 'number', range: [10000000, 999999999], required: true}],
...
var question05 = {
  type: 'survey-text',
  questions: [{prompt: '<div class="justified">Indique número de cuenta</div>', type: 'number', range: [-Infinity, Infinity], required: true}],
