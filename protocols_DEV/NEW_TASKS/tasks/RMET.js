...
var if_question001_1 = {
  ...
  data: {trialid: 'RMET_001_1_if', procedure: 'RMET'}
};
RMET.push(if_question001_1);

var question001_2 = {
  type: 'instructions',
  pages: ['<p>' +'La respuesta acertada era "en pánico". Al empezar la tarea no recibiras mas retroalimentacion.'+'</p>'],
  data: {trialid: 'Instructions_03', procedure: 'RMET'},
  button_label_previous: "Anterior",
  button_label_next: "Siguiente",
  show_clickable_nav: true,
  on_trial_start: function(){
...
var if_question001_2 = {
  ...
  data: {trialid: 'RMET_001_2_if', procedure: 'RMET'}
};
RMET.push(if_question001_2);
...
trials.forEach(function(trial) {
  RMET.push({
    ...
    button_label: 'Siguiente',
    data: {
      trialid: "RMET_" + String(index+1).padStart(3, '0'),
      procedure: 'RMET'
    }
  })
  index += 1;
