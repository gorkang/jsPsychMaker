...
var question000 = {
  ...
  data: {trialid: 'RMET_000', procedure: 'RMET'},
...
var question000_1 = {
  ...
  data: {trialid: 'question000_1', procedure: 'RMET'},
  button_label_previous: "Anterior",
  button_label_next: "Siguiente",
  show_clickable_nav: true,
  on_trial_start: function(){
...
var if_question000_1 = {
  ...
  conditional_function: function(){
    let data = (JSON.parse((jsPsych.data.get().values().find(x => x.trialid === 'RMET_000'))['response'])['Q0']).trim();
    if((data) ==  'EN PÁNICO'){
      return true;
    } else {
      return false;
  ...
  data: {trialid: 'RMET_000_1_if', procedure: 'RMET'}
};
...
var question000_2 = {
  ...
  data: {trialid: 'question000_2', procedure: 'RMET'},
  button_label_previous: "Anterior",
  button_label_next: "Siguiente",
  show_clickable_nav: true,
  on_trial_start: function(){
...
var if_question000_2 = {
  ...
  data: {trialid: 'RMET_000_2_if', procedure: 'RMET'}
};
