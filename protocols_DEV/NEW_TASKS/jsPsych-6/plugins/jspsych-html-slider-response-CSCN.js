...
jsPsych.plugins['html-slider-response-CSCN'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += '<input type="range" value="'+trial.start+'" min="'+trial.min+'" max="'+trial.max+'" step="'+trial.step+'" style="width: 100%;" id="jspsych-html-slider-response-response" class="custom-range"></input>';
    html += '<div>'
    ...
    function end_trial(){
      ...
      question = {};
      question_data = {};
      question["Q0"] = trial.stimulus;
      question_data["Q0"] = response.response;
      ...
      var trialdata = {
        "rt": response.rt,
        "stimulus": stripHtml(JSON.stringify(question)),
