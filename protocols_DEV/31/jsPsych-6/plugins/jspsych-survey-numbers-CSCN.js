...
jsPsych.plugins['survey-numbers'] = (function() {
    ...
    plugin.trial = function(display_element, trial) {
      ...
      html += "<table style='margin: auto'><tbody>" +
        ...
        "<tr><td colspan='2'><button class='jspsych-btn' style='width:100%'>0</button></td><td><button class='jspsych-btn jspsych-survey-numbers-next'><img src='controllers/media/tick.svg' width='8' height='8' style='margin-left: auto'></img></button></td></tr>" +
      "</tbody></table>";
