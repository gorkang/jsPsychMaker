...
var if_question39 = {
  ...
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = (JSON.parse((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_38'))["response"])["Q0"]).trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
var if_question42 = {
  ...
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = (JSON.parse((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_41'))["response"])["Q0"]).trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
var if_question45 = {
  ...
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = (JSON.parse((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_44'))["response"])["Q0"]).trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
var if_question48 = {
  ...
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = (JSON.parse((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_47'))["response"])["Q0"]).trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
var if_question51 = {
  ...
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = (JSON.parse((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_50'))["response"])["Q0"]).trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
var if_question54 = {
  ...
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = (JSON.parse((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_53'))["response"])["Q0"]).trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
var if_question57 = {
  ...
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = (JSON.parse((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_56'))["response"])["Q0"]).trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
var if_question60 = {
  ...
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = (JSON.parse((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_59'))["response"])["Q0"]).trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
var if_question63 = {
  ...
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = (JSON.parse((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_62'))["response"])["Q0"]).trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
