...
var instruction_screen_experiment = {
  ...
  data:{trialid: 'Instructions_001', procedure: 'AIM'},
...
var question01 = {
  ...
  data: {trialid: 'AIM_001', procedure: 'AIM'}
};
AIM.push(question01);
...
var question02 = {
  ...
  data: {trialid: 'AIM_002', procedure: 'AIM'}
};
AIM.push(question02);

var question03 = {
  type: 'survey-text',
  questions: [{prompt: 'Ahora, hablando de su hogar:<br> <br>Incluyéndose usted, ¿cuántas personas viven en su hogar en la actualidad? No considere el servicio doméstico, aunque sea puertas adentro.', type: 'number', required: true}],
  data: {trialid: 'AIM_003', procedure: 'AIM'}
};
AIM.push(question03);
...
var question04 = {
  ...
  data: {trialid: 'AIM_004', procedure: 'AIM'}
};

var if_question04 = {
  timeline: [question04],
  data: {trialid: 'AIM_004_if', procedure: 'AIM'},
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = (JSON.parse((jsPsych.data.get().values().find(x => x.trialid === 'AIM_003'))["response"])["Q0"]).trim();
    if(parseInt(data) == 1){
      return true;
    } else {
      return false;
...
var question05 = {
  ...
  data: {trialid: 'AIM_005', procedure: 'AIM'}
};

var if_question05 = {
  timeline: [question05],
  data: {trialid: 'AIM_005_if', procedure: 'AIM'},
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = (JSON.parse((jsPsych.data.get().values().find(x => x.trialid === 'AIM_003'))["response"])["Q0"]).trim();
...
var question06 = {
  ...
  data: {trialid: 'AIM_006', procedure: 'AIM'}
};

var if_question06 = {
  timeline: [question06],
  data: {trialid: 'AIM_006_if', procedure: 'AIM'},
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = (JSON.parse((jsPsych.data.get().values().find(x => x.trialid === 'AIM_003'))["response"])["Q0"]).trim();
...
var question07 = {
  ...
  data: {trialid: 'AIM_007', procedure: 'AIM'}
};

var if_question07 = {
  timeline: [question07],
  data: {trialid: 'AIM_007_if', procedure: 'AIM'},
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = (JSON.parse((jsPsych.data.get().values().find(x => x.trialid === 'AIM_003'))["response"])["Q0"]).trim();
...
var question08 = {
  ...
  data: {trialid: 'AIM_008', procedure: 'AIM'}
};

var if_question08 = {
  timeline: [question08],
  data: {trialid: 'AIM_008_if', procedure: 'AIM'},
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = (JSON.parse((jsPsych.data.get().values().find(x => x.trialid === 'AIM_003'))["response"])["Q0"]).trim();
...
var question09 = {
  ...
  data: {trialid: 'AIM_009', procedure: 'AIM'}
};

var if_question09 = {
  timeline: [question09],
  data: {trialid: 'AIM_009_if', procedure: 'AIM'},
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = (JSON.parse((jsPsych.data.get().values().find(x => x.trialid === 'AIM_003'))["response"])["Q0"]).trim();
...
var question10 = {
  ...
  data: {trialid: 'AIM_010', procedure: 'AIM'}
};

var if_question10 = {
  timeline: [question10],
  data: {trialid: 'AIM_010_if', procedure: 'AIM'},
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = (JSON.parse((jsPsych.data.get().values().find(x => x.trialid === 'AIM_003'))["response"])["Q0"]).trim();
