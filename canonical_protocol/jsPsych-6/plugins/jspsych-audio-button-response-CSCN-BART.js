...
jsPsych.plugins["audio-button-response"] = (function () {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      block_size: {
        ...
        default: undefined,
        array: true,
        description: 'Array with width and height of block for the image.'
      },
      size: {
        type: jsPsych.plugins.parameterType.STRING,
        pretty_name: 'size',
        default: undefined,
        array: true,
        description: 'Array with width and height of image.'
      },
      button_html: {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    function setupTrial() {
      ...
      html += '<div class="column" style="height: ' + trial.block_size[0]*0.33 + 'px; width: ' + trial.block_size[1]*0.75 + 'px;">'
      html += '<div>'
      ...
      for (var i = 0; i < buttons.length; i++) {
        /*if (i == buttons.length - 1)
          html += '<div class="jspsych-audio-button-response-button" style="cursor: pointer; display: inline-block; margin:' + trial.margin_vertical + ' ' + trial.margin_horizontal + '" id="jspsych-audio-button-response-button-' + i + '" data-choice="' + i + '">' + buttons[i] + '</div>';
        else*/
        html += '<div style="cursor: pointer; display: inline-block; margin:' + trial.margin_vertical + ' ' + trial.margin_horizontal + '">' + buttons[i] + '</div>';
      }
      html += '</div>'

      html += '<div class="column" style="height: ' + trial.block_size[0] + 'px; width: ' + trial.block_size[1] + 'px;">'
      html += '<img src="' + trial.choices + '" alt="BART_redBalloon" status=0 id="BART_redBalloon" width="' + trial.size[0] + '" height="' + trial.size[1] + '" style="display: block;">'
      html += '</div>'
