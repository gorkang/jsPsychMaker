...
var question001_1 = {
  ...
  questions: [{prompt: '<div class="justified">Indique nombre o alias que desee que aparezca personalizado en el informe.</div>', required: true}],
...
var if_question001_1 = {
  ...
  conditional_function: function(){
    let data = ((jsPsych.data.get().values().find(x => x.trialid === 'Report_001'))['response']['Q0']).toString().trim();
