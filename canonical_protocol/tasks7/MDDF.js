...
var if_question03 = {
  ...
  conditional_function: function(){
    ...
    let data = ((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_02'))["response"]["Q0"]).toString().trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
var if_question06 = {
  ...
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = ((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_05'))["response"]["Q0"]).toString().trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
var if_question09 = {
  ...
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = ((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_08'))["response"]["Q0"]).toString().trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
var if_question12 = {
  ...
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = ((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_11'))["response"]["Q0"]).toString().trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
var if_question15 = {
  ...
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = ((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_14'))["response"]["Q0"]).toString().trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
var question16 = {
  type: jsPsychSurveyMultiChoice,
  questions: [{prompt: '<div class="justified"><p>4. Un hombre orina intencionalmente en el piso del baño.</p><p>¿En qué medida esto le parece inadecuado o adecuado?</p></div>', options: ['Muy inadecuado', 'Medianamente inadecuado', 'Poco inadecuado', 'Sin opinion', 'Un poco adecuado', 'Medianamente adecuado', 'Altamente adecuado'], required: true, horizontal: false}],
...
var question17 = {
  type: jsPsychSurveyMultiChoice,
  questions: [{prompt: '<div class="justified"><p>4. Un hombre orina intencionalmente en el piso del baño.</p><p>¿Usted considera que en esta situación alguien ha sufrido un daño?</p></div>', options: ['&nbsp;Si', '&nbsp;No'], required: true, horizontal: false}],
...
var question18 = {
  type: jsPsychHtmlSliderResponse,
  stimulus: "<div class='justified'>4. Un hombre orina intencionalmente en el piso del baño.</p><p>Si usted considera que alguien sufrió un daño en esta situación, ¿Que tanto daño cree usted que sufrió? </p></div></br>", require_movement:true, required: true, min: 1, max: 7, slider_width: 500, slider_start: 4, step: 1, labels: ["Poco daño", "Mucho daño"], button_label: "Siguiente",
...
var if_question18 = {
  ...
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = ((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_17'))["response"]["Q0"]).toString().trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
var question19 = {
  type: jsPsychSurveyMultiChoice,
  questions: [{prompt: '<div class="justified"><p>5. Alguien deja una rata muerta en la cocina de su vecino.</p><p>¿En qué medida esto le parece inadecuado o adecuado?</p></div>', options: ['Muy inadecuado', 'Medianamente inadecuado', 'Poco inadecuado', 'Sin opinion', 'Un poco adecuado', 'Medianamente adecuado', 'Altamente adecuado'], required: true, horizontal: false}],
...
var question20 = {
  type: jsPsychSurveyMultiChoice,
  questions: [{prompt: '<div class="justified"><p>5. Alguien deja una rata muerta en la cocina de su vecino.</p><p>¿Usted considera que en esta situación alguien ha sufrido un daño?</p></div>', options: ['&nbsp;Si', '&nbsp;No'], required: true, horizontal: false}],
...
var question21 = {
  type: jsPsychHtmlSliderResponse,
  stimulus: "<div class='justified'>5. Alguien deja una rata muerta en la cocina de su vecino.</p><p>Si usted considera que alguien sufrió un daño en esta situación, ¿Que tanto daño cree usted que sufrió? </p></div></br>", require_movement:true, required: true, min: 1, max: 7, slider_width: 500, slider_start: 4, step: 1, labels: ["Poco daño", "Mucho daño"], button_label: "Siguiente",
...
var if_question21 = {
  ...
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = ((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_20'))["response"]["Q0"]).toString().trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
var if_question24 = {
  ...
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = ((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_23'))["response"]["Q0"]).toString().trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
var if_question27 = {
  ...
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = ((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_26'))["response"]["Q0"]).toString().trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
var if_question30 = {
  ...
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = ((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_29'))["response"]["Q0"]).toString().trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
var if_question33 = {
  ...
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = ((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_32'))["response"]["Q0"]).toString().trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
var question34 = {
  type: jsPsychSurveyMultiChoice,
  questions: [{prompt: '<div class="justified"><p>5. Una mujer bebió un vaso de agua que contenía la saliva de otra persona.</p><p>¿En qué medida esto le parece inadecuado o adecuado?</p></div>', options: ['Muy inadecuado', 'Medianamente inadecuado', 'Poco inadecuado', 'Sin opinion', 'Un poco adecuado', 'Medianamente adecuado', 'Altamente adecuado'], required: true, horizontal: false}],
...
var question35 = {
  type: jsPsychSurveyMultiChoice,
  questions: [{prompt: '<div class="justified"><p>5. Una mujer bebió un vaso de agua que contenía la saliva de otra persona.</p><p>¿Usted considera que en esta situación alguien ha sufrido un daño?</p></div>', options: ['&nbsp;Si', '&nbsp;No'], required: true, horizontal: false}],
  data: {trialid: 'MDDF_35', procedure: 'MDDF'}
};
MDDF.push(question35);

var question36 = {
  type: jsPsychHtmlSliderResponse,
  stimulus: "<div class='justified'>5. Una mujer bebió un vaso de agua que contenía la saliva de otra persona.</p><p>Si usted considera que alguien sufrió un daño en esta situación, ¿Que tanto daño cree usted que sufrió? </p></div></br>", require_movement:true, required: true, min: 1, max: 7, slider_width: 500, slider_start: 4, step: 1, labels: ["Poco daño", "Mucho daño"], button_label: "Siguiente",
...
var if_question36 = {
  ...
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = ((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_35'))["response"]["Q0"]).toString().trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
var if_question39 = {
  timeline: [question39],
  data: {trialid: 'MDDF_39_if', procedure: 'MDDF'},
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = ((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_38'))["response"]["Q0"]).toString().trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
var if_question42 = {
  timeline: [question42],
  data: {trialid: 'MDDF_42_if', procedure: 'MDDF'},
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = ((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_41'))["response"]["Q0"]).toString().trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
var if_question45 = {
  timeline: [question45],
  data: {trialid: 'MDDF_45_if', procedure: 'MDDF'},
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = ((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_44'))["response"]["Q0"]).toString().trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
MDDF.push(if_question45);

var question46 = {
  type: jsPsychSurveyMultiChoice,
  questions: [{prompt: '<div class="justified"><p>2. Una mujer va a un restaurante a cenar.</p><p>¿En qué medida esto le parece inadecuado o adecuado?</p></div>', options: ['Muy inadecuado', 'Medianamente inadecuado', 'Poco inadecuado', 'Sin opinion', 'Un poco adecuado', 'Medianamente adecuado', 'Altamente adecuado'], required: true, horizontal: false}],
...
var question47 = {
  type: jsPsychSurveyMultiChoice,
  questions: [{prompt: '<div class="justified"><p>2. Una mujer va a un restaurante a cenar.</p><p>¿Usted considera que en esta situación alguien ha sufrido un daño?</p></div>', options: ['&nbsp;Si', '&nbsp;No'], required: true, horizontal: false}],
  data: {trialid: 'MDDF_47', procedure: 'MDDF'}
};
MDDF.push(question47);

var question48 = {
  type: jsPsychHtmlSliderResponse,
  stimulus: "<div class='justified'>2. Una mujer va a un restaurante a cenar.</p><p>Si usted considera que alguien sufrió un daño en esta situación, ¿Que tanto daño cree usted que sufrió? </p></div></br>", require_movement:true, required: true, min: 1, max: 7, slider_width: 500, slider_start: 4, step: 1, labels: ["Poco daño", "Mucho daño"], button_label: "Siguiente",
  data: {trialid: 'MDDF_48', procedure: 'MDDF'}
};

var if_question48 = {
  timeline: [question48],
  data: {trialid: 'MDDF_48_if', procedure: 'MDDF'},
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = ((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_47'))["response"]["Q0"]).toString().trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
var if_question51 = {
  timeline: [question51],
  data: {trialid: 'MDDF_51_if', procedure: 'MDDF'},
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = ((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_50'))["response"]["Q0"]).toString().trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
MDDF.push(if_question51);

var question52 = {
  type: jsPsychSurveyMultiChoice,
  questions: [{prompt: '<div class="justified"><p>4. Una persona toma el bus hacia la ciudad el fin de semana.</p><p>¿En qué medida esto le parece inadecuado o adecuado?</p></div>', options: ['Muy inadecuado', 'Medianamente inadecuado', 'Poco inadecuado', 'Sin opinion', 'Un poco adecuado', 'Medianamente adecuado', 'Altamente adecuado'], required: true, horizontal: false}],
...
var question53 = {
  type: jsPsychSurveyMultiChoice,
  questions: [{prompt: '<div class="justified"><p>4. Una persona toma el bus hacia la ciudad el fin de semana.</p><p>¿Usted considera que en esta situación alguien ha sufrido un daño?</p></div>', options: ['&nbsp;Si', '&nbsp;No'], required: true, horizontal: false}],
  data: {trialid: 'MDDF_53', procedure: 'MDDF'}
};
MDDF.push(question53);

var question54 = {
  type: jsPsychHtmlSliderResponse,
  stimulus: "<div class='justified'>4. Una persona toma el bus hacia la ciudad el fin de semana.</p><p>Si usted considera que alguien sufrió un daño en esta situación, ¿Que tanto daño cree usted que sufrió? </p></div></br>", require_movement:true, required: true, min: 1, max: 7, slider_width: 500, slider_start: 4, step: 1, labels: ["Poco daño", "Mucho daño"], button_label: "Siguiente",
  data: {trialid: 'MDDF_54', procedure: 'MDDF'}
};

var if_question54 = {
  timeline: [question54],
  data: {trialid: 'MDDF_54_if', procedure: 'MDDF'},
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = ((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_53'))["response"]["Q0"]).toString().trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
MDDF.push(if_question54);

var question55 = {
  type: jsPsychSurveyMultiChoice,
  questions: [{prompt: '<div class="justified"><p>5. Una persona tiende su cama en la mañana.</p><p>¿En qué medida esto le parece inadecuado o adecuado?</p></div>', options: ['Muy inadecuado', 'Medianamente inadecuado', 'Poco inadecuado', 'Sin opinion', 'Un poco adecuado', 'Medianamente adecuado', 'Altamente adecuado'], required: true, horizontal: false}],
...
var question56 = {
  type: jsPsychSurveyMultiChoice,
  questions: [{prompt: '<div class="justified"><p>5. Una persona tiende su cama en la mañana.</p><p>¿Usted considera que en esta situación alguien ha sufrido un daño?</p></div>', options: ['&nbsp;Si', '&nbsp;No'], required: true, horizontal: false}],
  data: {trialid: 'MDDF_56', procedure: 'MDDF'}
};
MDDF.push(question56);

var question57 = {
  type: jsPsychHtmlSliderResponse,
  stimulus: "<div class='justified'>5. Una persona tiende su cama en la mañana.</p><p>Si usted considera que alguien sufrió un daño en esta situación, ¿Que tanto daño cree usted que sufrió? </p></div></br>", require_movement:true, required: true, min: 1, max: 7, slider_width: 500, slider_start: 4, step: 1, labels: ["Poco daño", "Mucho daño"], button_label: "Siguiente",
  data: {trialid: 'MDDF_57', procedure: 'MDDF'}
};

var if_question57 = {
  timeline: [question57],
  data: {trialid: 'MDDF_57_if', procedure: 'MDDF'},
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = ((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_56'))["response"]["Q0"]).toString().trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
MDDF.push(if_question57);

var question58 = {
  type: jsPsychSurveyMultiChoice,
  questions: [{prompt: '<div class="justified"><p>6. Una persona toma el ascensor para ir al último piso de un edificio.</p><p>¿En qué medida esto le parece inadecuado o adecuado?</p></div>', options: ['Muy inadecuado', 'Medianamente inadecuado', 'Poco inadecuado', 'Sin opinion', 'Un poco adecuado', 'Medianamente adecuado', 'Altamente adecuado'], required: true, horizontal: false}],
...
var question59 = {
  type: jsPsychSurveyMultiChoice,
  questions: [{prompt: '<div class="justified"><p>6. Una persona toma el ascensor para ir al último piso de un edificio.</p><p>¿Usted considera que en esta situación alguien ha sufrido un daño?</p></div>', options: ['&nbsp;Si', '&nbsp;No'], required: true, horizontal: false}],
  data: {trialid: 'MDDF_59', procedure: 'MDDF'}
};
MDDF.push(question59);

var question60 = {
  type: jsPsychHtmlSliderResponse,
  stimulus: "<div class='justified'>6. Una persona toma el ascensor para ir al último piso de un edificio.</p><p>Si usted considera que alguien sufrió un daño en esta situación, ¿Que tanto daño cree usted que sufrió? </p></div></br>", require_movement:true, required: true, min: 1, max: 7, slider_width: 500, slider_start: 4, step: 1, labels: ["Poco daño", "Mucho daño"], button_label: "Siguiente",
  data: {trialid: 'MDDF_60', procedure: 'MDDF'}
};

var if_question60 = {
  timeline: [question60],
  data: {trialid: 'MDDF_60_if', procedure: 'MDDF'},
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = ((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_59'))["response"]["Q0"]).toString().trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
...
MDDF.push(question62);

var question63 = {
  type: jsPsychHtmlSliderResponse,
  stimulus: "<div class='justified'>7. Una persona come una manzana al desayuno.</p><p>Si usted considera que alguien sufrió un daño en esta situación, ¿Que tanto daño cree usted que sufrió? </p></div></br>", require_movement:true, required: true, min: 1, max: 7, slider_width: 500, slider_start: 4, step: 1, labels: ["Poco daño", "Mucho daño"], button_label: "Siguiente",
  data: {trialid: 'MDDF_63', procedure: 'MDDF'}
};

var if_question63 = {
  timeline: [question63],
  data: {trialid: 'MDDF_63_if', procedure: 'MDDF'},
  conditional_function: function(){
    // get the data from the previous trial,
    // and check which key was pressed
    let data = ((jsPsych.data.get().values().find(x => x.trialid === 'MDDF_62'))["response"]["Q0"]).toString().trim();
    if(data == "Si"){
      return true;
    } else {
      return false;
