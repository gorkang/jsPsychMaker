...
var question01 = {
  ...
  questions: [{prompt: '<div class="justified">Imagina que lanzamos una moneda no trucada en 1.000 ocasiones. <BR><BR>Haz una estimación: ¿Cuántas veces saldrá cara en los 1.000 intentos?</div>', input_type: 'number', min: 0, max: 1000, required: true, error_text: 'Tienes que introducir un número entre 0 y 1000'}],
...
var question04 = {
  type: jsPsychSurveyText,
  questions: [{prompt: '<div class="justified">Imagina que lanzamos un dado no trucado en 1.000 ocasiones. <BR><BR>¿En cuántas de estas 1.000 ocasiones crees que saldrá un número par (2, 4, 6)?</div>', input_type: 'number', min: 0, max: 1000, required: true, error_text: 'Tienes que introducir un número entre 0 y 1000'}],
...
var question07 = {
  type: jsPsychSurveyText,
  questions: [{prompt: '<div class="justified">Si la probabilidad de contraer una enfermedad es del 10 %, ¿cuántas personas esperas que contraigan la enfermedad en un grupo de 1,000?</div>', input_type: 'number', min: 0, max: 1000, required: true, error_text: 'Tienes que introducir un número entre 0 y 1000'}],
...
var question08 = {
  type: jsPsychSurveyText,
  questions: [{prompt: '<div class="justified">Si la probabilidad de contraer una enfermedad es de 20 en 100, esto implicaría que hay una probabilidad del _______ % de contraer la enfermedad</div>', input_type: 'number', min: 0, max: 100, required: true, error_text: 'Tienes que introducir un porcentaje entre 0 y 100'}],
...
var question09 = {
  type: jsPsychSurveyText,
  questions: [{prompt: '<div class="justified">Si el riesgo de que una persona llamada A contraiga una enfermedad es de 1 entre 100 en diez años, y el riesgo de que la contraiga una persona llamada B es el doble que A, ¿cuál es el riesgo de que la contraiga B? (____ entre 100)</div>', input_type: 'number', required: true}],
