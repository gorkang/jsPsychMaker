...
var instruction_screen_experiment = {
  ...
  pages: ['<p><left>' + '<p><left><b><big>Última tarea</big></b><br />'+'Por favor, contesta a las siguientes preguntas sobre el estudio' +'</p>'],
...
var question02 = {
  ...
  questions: [{prompt: '<div class="justified">¡Gracias por su tiempo y esfuerzo!<BR><BR>En la siguiente pantalla te daremos tu código anónimo de participación.<BR><BR>Por favor, haznos saber si tienes algún comentario o sugerencia con respecto al estudio que acabas de terminar.</div>', required: true}],
