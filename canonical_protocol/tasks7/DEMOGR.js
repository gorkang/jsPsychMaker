...
questions.push( check_fullscreen('DEMOGR') );
DEMOGR = [];    //temporal timeline

var instruction_screen_experiment = {
  type: jsPsychInstructions,
  pages: [`<b><big>Información demográfica</big></b><BR>Por favor, contesta a las siguientes preguntas<BR><BR>`],
...
var question01 = {
  ...
  questions: [{prompt: '<div class="justified">Indica tu edad</div>', input_type: 'number', min: 18, max: 100, required: true, error_text: 'Tienes que ser mayor de edad para poder participar'}],
...
var question04 = {
  type: jsPsychSurveyText,
  questions: [{prompt: '<div class="justified">Introduce tu número de celular (912345678)</div>', input_type: 'number', min: 900000000, max: 9999999999, required: true, error_text: 'Tienes que introducir un celular valido (ej. 9 1234 5678 pero sin los espacios)'}],
...
var question09 = {
  type: jsPsychSurveyText,
  questions: [{prompt: '<div class="justified">Indica el nombre completo de lo que estás estudiando</div>', required: true}],
...
var if_question09 = {
  ...
  conditional_function: function(){
    let data = ((jsPsych.data.get().values().find(x => x.trialid === 'DEMOGR_08'))['response']['Q0']).toString().trim();
...
var question18 = {
  type: jsPsychSurveyText,
  questions: [{prompt: '<div class="justified">¿Cuántos hijos(as) te gustaría tener? (0, 1, 2, 3...)</div>', input_type: 'number', min: 0, required: true, error_text: 'Tienes que introducir un número'}],
