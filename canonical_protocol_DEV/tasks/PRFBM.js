...
var question01 = {
  ...
  questions: [{prompt: '<div class="justified">Imagina que estas embarazada, cerca de la fecha de parto, en buen estado de salud y tu bebé se desarrolla normalmente. <BR><BR>Si pudieras elegir la modalidad de parto, preferirías que fuera:</div>',
  options: ['Parto vaginal (extracción del bebé por el canal vaginal en forma espontánea, con o sin intervenciones como anestesia)', 'Parto por cesárea (extracción del bebé por medio de una cirugía con anestesia. Se realiza una incisión abdominal y una incisión para abrir el útero)'], required: true,  random_options: false, horizontal: false}],
